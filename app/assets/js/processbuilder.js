...
const { getMojangOS, isLibraryCompatible, mcVersionAtLeast }  = require('gaialauncher-core/common')
...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=GaïaLauncher')
                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'Gaïa-Launcher')
                            break
